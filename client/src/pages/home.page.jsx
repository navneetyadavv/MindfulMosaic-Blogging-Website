...
const Home = () => {
  ...
  return (
    <div>
      ...
      <section className="h-cover bg-white-200 flex justify-center gap-10 ">
        {/* latest blog */}
                  ...
                  return (
                    ...
                    >
                      <BlogPostCard
                        ...
                        className="border-5 border-yellow-300"
                      />
                    </AnimationWrapper>
                  );
                })
        ...
        {/* filter and trending */}
        <div
          className={`min-w-[40%] lg:min-w-[400px] max-w-min border-l ${
            theme === "dark" ? "border-darkGrey" : "border-lightGrey"
          } pl-8 pt-3 max-md:hidden`}
        >
