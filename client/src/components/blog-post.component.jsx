...
const BlogPostCard = ({content, author}) => {
  ...
  return (
    <Link to={`/blog/${id}`} className={`flex gap-8 items-center border rounded-xl  p-5 mb-4 ${theme === 'dark' ? 'bg-black-blue border-darkGrey hover:shadow-custom '  : 'bg-white border-lightGrey hover:shadow-md'}  duration-300 transition-all hover:scale-102`}>
    <div className='w-full'>
        ...
        <div className='flex gap-4 mt-7'>
            ...
            <span className='ml-3 flex items-center gap-2 text-dark-grey'>
                <i className='fi fi-rr-heart text-red text-xl'></i>{total_likes} 
            </span>
        </div>
    </div>
